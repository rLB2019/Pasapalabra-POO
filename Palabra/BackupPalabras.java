 ...
 * @author MrKanoa
 */
public class BackupPalabras {
    private AlmacenPalabras almacen;

    public BackupPalabras() {
        this.almacen = new AlmacenPalabras();
    }
    
    public BackupPalabras(AlmacenPalabras nuevoAlmacen){
        this.almacen = nuevoAlmacen;
    }
    
    public AlmacenPalabras getAlmacen(){
        return this.almacen;
    }
    ...
    public boolean cargarBackup(File fichero) {
        ...
        try {
            ...
            this.almacen = (AlmacenPalabras) entradaObjetos.readObject();
